# Support for Output Descriptors in CubeCoin Core

Since CubeCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `cc1...` for mainnet or `tcc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing CubeCoin Core wallets, a convenience function `combo` is

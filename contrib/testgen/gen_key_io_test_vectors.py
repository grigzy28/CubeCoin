...
bech32_templates = [
  ...
  ('rcc',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rcc',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rcc',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rcc', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]

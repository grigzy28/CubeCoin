Contributing to CubeCoin Core
============================

The CubeCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the CubeCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/cubecoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to cubecoin-qt
...
The following applies to code changes to the CubeCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall CubeCoin
Network Protocol consensus changes.

Whether a pull request is merged into CubeCoin Core rests with the project merge
...
Patches that change CubeCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CubeCoin consensus, it must have been
...
The project leader is the release manager for each CubeCoin Core release.

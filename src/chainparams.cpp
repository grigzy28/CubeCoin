...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x03c65635787193103de553fb4f31587d9b07861a72938f616946b38fd98ed372");
        ...
        genesis = CreateGenesisBlock(1727736365, 1912609, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x03c65635787193103de553fb4f31587d9b07861a72938f616946b38fd98ed372"));
        assert(genesis.hashMerkleRoot == uint256S("0x749a177453ac714c5a6422ddd6ec1a10bcb9ff86a39398d41efcab58e3265d4d"));
        ...
        checkpointData = {
            {
                {  0, uint256S("0x03c65635787193103de553fb4f31587d9b07861a72938f616946b38fd98ed372")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0xf941d6d431954f23d67bf9f6e4f2b477bdf41a785f5756edabe0844313ecd2bd"); 
        ...
        genesis = CreateGenesisBlock(1699986298, 48389, 0x1e0ffff0, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0xf941d6d431954f23d67bf9f6e4f2b477bdf41a785f5756edabe0844313ecd2bd"));
        //assert(genesis.hashMerkleRoot == uint256S("0x2a80009a811fe6f1a367f543216c48d3acf7ffc68b0d5c0e580dc296e567f2ae"));
        ...
        checkpointData = {
            {
                {0, uint256S("f941d6d431954f23d67bf9f6e4f2b477bdf41a785f5756edabe0844313ecd2bd")},
            }
        };

        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 f941d6d431954f23d67bf9f6e4f2b477bdf41a785f5756edabe0844313ecd2bd
            /* nTime    */ 1699986298,
            /* nTxCount */ 0,
            /* dTxRate  */ 0,
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1699986314, 0, 0x207fffff, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x813dadbacb9c2430c7b7eb8048da82a7d26d3026eaaa25108b441bc78f24ff1c"));
        //assert(genesis.hashMerkleRoot == uint256S("0x2a80009a811fe6f1a367f543216c48d3acf7ffc68b0d5c0e580dc296e567f2ae"));
        ...
        checkpointData = {
            {
                {0, uint256S("813dadbacb9c2430c7b7eb8048da82a7d26d3026eaaa25108b441bc78f24ff1c")},
            }
        };

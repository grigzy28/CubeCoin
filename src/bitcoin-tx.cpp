...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cubecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cubecoin-tx [options] <hex-tx> [commands]  Update hex-encoded cubecoin transaction\n" +
            "or:     cubecoin-tx [options] -create [commands]   Create hex-encoded cubecoin transaction\n" +
            "\n";

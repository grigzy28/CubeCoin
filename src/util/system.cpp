...
const char * const BITCOIN_CONF_FILENAME = "cubecoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CubeCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/CubeCoin";
#else
    // Unix-like
    return pathRet / ".cubecoin";
#endif
#endif
}

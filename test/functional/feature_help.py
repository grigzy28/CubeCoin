...
"""Verify that starting cubecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cubecoin with -h for help text")
        ...
        self.log.info("Start cubecoin with -version for version information")
        ...
        self.log.info("Start cubecoind with -fakearg to make sure it does not start")
